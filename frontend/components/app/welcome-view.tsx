                  ...
                  .map((esc) => (
                    <div key={esc.id} className="bg-white rounded border border-slate-200 shadow-sm p-6 text-left relative overflow-hidden transition-all duration-200 hover:shadow-md">
                      ...
                      <div className={`absolute top-0 left-0 bottom-0 w-1.5 ${
                        esc.urgency?.toLowerCase() === 'emergency' ? 'bg-purple-600' :
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                            ...
                            <span className={`text-[10px] font-extrabold px-2.5 py-0.5 rounded uppercase tracking-wider ${
                              esc.urgency?.toLowerCase() === 'emergency' ? 'bg-purple-100 text-purple-800 border border-purple-200' :
                            ...
                            <span className={`text-[10px] font-bold px-2 py-0.5 rounded ${
                              esc.status?.toLowerCase() === 'resolved' ? 'bg-emerald-100 text-emerald-800' :
                              ...
                              <tr key={call.call_id} className="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td className="p-4">
                                  <span className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase ${
                                    call.is_sip ? 'bg-indigo-50 text-indigo-705 border border-indigo-100' : 'bg-blue-50 text-blue-705 border border-blue-100'
                                  }`}>
